            ...
            <div class="row no-gutter">
                ...
                <div class="col-lg-4 col-sm-6">
                 ...
                 <!--    <a href="#" class="portfolio-box" name="menuChoice" onclick="$(findBeers).closest('menu.do').submit()">Submit</a> -->   
                    ...
                    <input type="image" name="menuChoice" value="findBeers" class="img-responsive"  src="img/portfolio/1.jpg" alt=""/>
...
<!--                         <input class="portfolio-box" type="image" name="menuChoice" src="img/portfolio/1.jpg" class="img-responsive" alt="" border="0" value="findBeers" alt="Submit" />
 -->                        
                        <div class="portfolio-box-caption">
                            <div class="portfolio-box-caption-content">
                               <!--  <div class="project-category text-faded">
                                ...
                                <div align="center" class="project-name">
                                    Find Brews
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-4 col-sm-6">
                 ...
                 <!--    <a href="#" class="portfolio-box" name="menuChoice" onclick="$(findBeers).closest('menu.do').submit()">Submit</a> -->   
                    <a href="#" class="porfolio-box" >
                    <input type="image" name="menuChoice" value="findBreweries" class="img-responsive"  src="img/portfolio/2.jpg" alt=""/>
...
<!--                         <input class="portfolio-box" type="image" name="menuChoice" src="img/portfolio/1.jpg" class="img-responsive" alt="" border="0" value="findBeers" alt="Submit" />
 -->                        
                ...
                <div class="col-lg-4 col-sm-6">
                 ...
                 <!--    <a href="#" class="portfolio-box" name="menuChoice" onclick="$(findBeers).closest('menu.do').submit()">Submit</a> -->   
                    <a href="#" class="porfolio-box" >
                    <input type="image" name="menuChoice" value="viewUserBeers" class="img-responsive"  src="img/portfolio/3.jpg" alt=""/>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 text-center">
                    ...
                    <p><a href="mailto:your-email@your-domain.com">feedback@TapMinder.com</a></p>
                </div>
            </div>
        </div>
    </section>
