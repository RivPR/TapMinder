...
<head>
    ...
    <!-- Bootstrap Core CSS -->
 <!-- 
    IN ORDER TO PATH INTO THE BOOTSTRAP FILES FROM THE HEADER FILE that exists in includes.header.jsp NO FORWARD SLASH IS NEEDED for the path so it can be navigated into
 -->   
